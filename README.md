...
Fly an F-15 fighter through a photorealistic Google 3D world view (when a Google Maps API key is supplied), with throttle-controlled engine audio, a 3D cockpit plane model, and a cinematic HUD overlay.
...
- **Space**: air brake
- **Mouse wheel**: fine throttle control
- **M**: mute engine
